...
*/
 ...
 /*
Modified by Team 27
-Disabled sunset time as it was confusing to end users and there was not enough space in module to explain
-Modified update interval to avoid overloading API (60 calls per minute per key, shared with other weather modules)
 */
...
Module.register("currentweather",{
	...
	addExtraInfoWeather: function(wrapper) {
		...
		// Remote sunrise time - removed due to space constraints
		// Additionally, without going through the code, the
		// end users wouldn't know what it is for and might be confused
