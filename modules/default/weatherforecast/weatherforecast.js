...
/*
Modified by Team 27
-Fixed update interval to disable console spam and API overload
-API key is shared with current weather (so a minimum of 2 API calls each time)
-Additionally, hiding/showing a module will restart it and call API again
*/
...
Module.register("weatherforecast",{
	...
	defaults: {
		...
		initialLoadDelay: 2500,	// 2.5 seconds delay. OpenWeather API throws error if calls are too close to each other
		retryDelay: 2500,
